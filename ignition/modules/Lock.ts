...
const LockModule = buildModule("Kettle", (m) => {
  ...
  const conduit = m.contract("TransferConduit");
  ...
  m.call(lending, "__LendingController_init", [conduit, receipt, owner]);
  ...
  m.call(kettle, "__Kettle_init", [conduit, lending, escrow, owner]);
