...
export interface TestOfferControllerInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "amountTaken" | "cancelOffers" | "cancelOffersForUser" | "cancelledOrFulfilled" | "hashLoanOffer" | "hashMarketOffer" | "incrementNonce" | "initialize" | "nonces" | "owner" | "pendingOwner" | "renounceOwnership" | "takeLoanOffer" | "takeMarketOffer" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "takeLoanOffer", values: [
        BigNumberish,
        LoanOfferStruct,
        BigNumberish,
        BytesLike,
    ...
    encodeFunctionData(functionFragment: "takeMarketOffer", values: [BigNumberish, MarketOfferStruct, BytesLike, BytesLike[]]): string;
    ...
    decodeFunctionResult(functionFragment: "takeLoanOffer", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "takeMarketOffer", data: BytesLike): Result;
...
export interface TestOfferController extends BaseContract {
    connect(runner?: ContractRunner | null): TestOfferController;
    waitForDeployment(): Promise<this>;
    interface: TestOfferControllerInterface;
    ...
    takeLoanOffer: TypedContractMethod<[
    ...
    takeMarketOffer: TypedContractMethod<[
        tokenId: BigNumberish,
        offer: MarketOfferStruct,
        signature: BytesLike,
        proof: BytesLike[]
    ...
    getFunction(nameOrSignature: "takeLoanOffer"): TypedContractMethod<[
        tokenId: BigNumberish,
        offer: LoanOfferStruct,
        amount: BigNumberish,
        signature: BytesLike,
    ...
    getFunction(nameOrSignature: "takeMarketOffer"): TypedContractMethod<[
        tokenId: BigNumberish,
        offer: MarketOfferStruct,
        signature: BytesLike,
        proof: BytesLike[]
