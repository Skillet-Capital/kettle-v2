...
export interface TransferConduitInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "channelOpen" | "owner" | "pendingOwner" | "renounceOwnership" | "transferERC20From" | "transferERC721From" | "transferOwnership" | "updateChannel"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferStarted" | "OwnershipTransferred"): EventFragment;
    encodeFunctionData(functionFragment: "acceptOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "channelOpen", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "channelOpen", data: BytesLike): Result;
...
export interface TransferConduit extends BaseContract {
    connect(runner?: ContractRunner | null): TransferConduit;
    waitForDeployment(): Promise<this>;
    interface: TransferConduitInterface;
    ...
    channelOpen: TypedContractMethod<[channel: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "channelOpen"): TypedContractMethod<[channel: AddressLike], [boolean], "view">;
