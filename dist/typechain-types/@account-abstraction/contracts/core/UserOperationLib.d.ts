...
export interface UserOperationLib extends BaseContract {
    ...
    getFunction(nameOrSignature: "PAYMASTER_DATA_OFFSET"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "PAYMASTER_POSTOP_GAS_OFFSET"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "PAYMASTER_VALIDATION_GAS_OFFSET"): TypedContractMethod<[], [bigint], "view">;
    filters: {};
}
